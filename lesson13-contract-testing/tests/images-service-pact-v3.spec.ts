        ...
        it('Run Image Service Consumer test', () => {
            provider.executeTest(async (mockImageService) => {
                imageService = new ImageService(
                    mockImageService.url, 'live_uuprBFKIIvV9ksh2V2afoDdApLX5WVTqEqIsuepjO5HRk02nBq6XgMF5sNNhVuCC');
                ...
                expect(filteredImages).to.contain.keys(
                    'id', 'url', 'width', 'height', 'sub_id', 'created_at',
                    'original_filename', 'breed_ids', 'breeds'
                );
